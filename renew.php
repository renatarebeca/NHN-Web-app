...
<html lang="en">
    ...
    <body>
        <div><h3 style="color:#3b6035;margin-top:80px; text-align:center; margin-bottom:20;">RENEW MEMBERSHIP</h3></div>

        <div style="background-color: #d5f3d3; padding: 0.5em;">
            <h3 style='color: #3b6035; font-style: italic bold;' class="crsname">--- NHN GYM -------------------</h3>
            <div style="margin-left: 30px;">
                <p style="color: #3b6135;"> PURCHASE FOR ANOTHER</p>
                ...
                <p style="margin-top: 10px;font-size: 0.9em; margin-left: 40px;">FOR <b> 500 kr.</b><script> if </script></p>
